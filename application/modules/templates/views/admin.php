...
<head>
	...
	<!--[if lt IE 9]>
	  	<script src="<?php echo base_url(); ?>adminfiles/http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo base_url() ?>store_items/manage"><i class="icon-tag"></i><span class="hidden-tablet"> Manage Item</span></a></li>
						<li><a href="<?php echo base_url() ?>store_accounts/manage"><i class="icon-briefcase"></i><span class="hidden-tablet"> Accounts</span></a></li>
						<li><a href="<?php echo base_url() ?>store_categories/manage"><i class="icon-align-justify"></i><span class="hidden-tablet"> Manage Categories</span></a></li>
